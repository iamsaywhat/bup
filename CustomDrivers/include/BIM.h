...
************************************************************/
#define BIM_CAN                   MDR_CAN1              // CAN Модуль - на котором сидит передатчик
#define BIM_CAN_RX	              PORT_Pin_9            // Номер RX ножки порта для CAN 
#define BIM_CAN_TX	              PORT_Pin_8            // Номер TX ножки порта для CAN 
#define BIM_CAN_CS1	              PORT_Pin_10           // Номер CS ножки порта для CAN 
#define BIM_CAN_PORT              MDR_PORTC             // Порт, к которому подключен передатчик 
#define RST_CLK_PCLK_BIM_PORT     RST_CLK_PCLK_PORTC    // Для включения тактирования порта, на котором будет сидеть выбранный CAN
...
#define BIM_SupplyPin             PORT_Pin_10           // Пин, к которому подключено реле коммутации питания для БИМ
...
**************************************************************************************************************/
#define BIM_Supply_ON()             PORT_SetBits   (BIM_SupplyPort, BIM_SupplyPin)


/**************************************************************************************************************
    BIM_Supply_OFF() - Макрос отключения питания на БИМа
**************************************************************************************************************/
#define BIM_Supply_OFF()            PORT_ResetBits (BIM_SupplyPort, BIM_SupplyPin)
...
/**************************************************************************************************************
	...
	Возвращает: 0 - Если ошибка при передаче (таймаут передачи)
