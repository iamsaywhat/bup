...
typedef enum {
  HANDLER_PC    = 0x4350,          // Заголовок пакетов от ЗПЗ к БУП (в символах на самом деле эквивалентно CP)
  HANDLER_PG    = 0x4750,          // Заголовок пакетов от ЗПЗ к СНС (в символах на самом деле эквивалентно GP)
  HANDLER_PW    = 0x5750,          // Заголовок пакетов от ЗПЗ к СВС (в символах на самом деле эквивалентно WP)
  HANDLER_BU    = 0x5542,          // Заголовок пакетов от БУП к ЗПЗ (в символах на самом деле эквивалентно UB)
  HANDLER_BG    = 0x4742,          // Заголовок пакетов от SNS к ЗПЗ (в символах на самом деле эквивалентно GB)
  HANDLER_BW    = 0x5742,          // Заголовок пакетов от СВС к ЗПЗ (в символах на самом деле эквивалентно WB)
}ZPZ_Handlers;
