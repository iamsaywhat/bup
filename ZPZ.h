...
typedef enum {
  ...
  HANDLER_TO_SWS     = 0x5741,          // Заголовок пакетов от ЗПЗ к СВС (в символах на самом деле эквивалентно WP)
  ...
  HANDLER_FROM_SWS   = 0x5741,          // Заголовок пакетов от СВС к ЗПЗ (в символах на самом деле эквивалентно WB)
}ZPZ_Handlers;
...
typedef enum {
	...
	REQ_SWS           = 0x57,       // "I" Команда запроса данных с SWS
